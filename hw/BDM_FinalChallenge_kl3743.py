...
if __name__ == "__main__":
    ...
    centerline = sc.textFile('Centerline.csv').mapPartitionsWithIndex(process_ctl)
    violations = sc.textFile('violation_sample.csv').mapPartitionsWithIndex(process_vio)
